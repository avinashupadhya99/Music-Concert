...
int cd=0,view=0,perf=1, l=1, numPoints, state=1, sstate=1;
...
void draw_blast(void)
{
    ...
    //Audience 3
    shirt[0]=0.8; shirt[1]=0.6; shirt[2]=0.9;
    pant[0]=0.3; pant[1]=0.3; pant[2]=0.3;
    hair[0]=0.0; hair[1]=0.0; hair[2]=0.0;
    skin[0]=1.0; skin[1]=0.9; skin[2]=0.6;

    glPushMatrix();
    glTranslated(-1.2,-0.5,1.5);
    draw_human(shirt,pant,hair,skin,1);
    glPopMatrix();

    //Audience 4
    shirt[0]=0.0; shirt[1]=0.8; shirt[2]=0.3;
    pant[0]=0.3; pant[1]=0.0; pant[2]=0.0;
    hair[0]=0.9; hair[1]=0.8; hair[2]=0.3;
    skin[0]=0.9; skin[1]=0.5; skin[2]=0.0;

    glPushMatrix();
    glTranslated(-1.7,-0.5,1.3);
    draw_human(shirt,pant,hair,skin,0);
    glPopMatrix();
    ...
    //Audience 8
    shirt[0]=0.0; shirt[1]=0.6; shirt[2]=0.9;
    pant[0]=0.0; pant[1]=0.1; pant[2]=0.3;
    hair[0]=0.0; hair[1]=0.0; hair[2]=0.0;
    skin[0]=1.0; skin[1]=0.9; skin[2]=0.6;
    ...
    if(view==0)//Not display the Welcome board in side view
    {
        ...
        std::string text;
        text="W";
        drawText(text.data(),text.size(),x_pos_txt[0],1.25,-7.5);
        text="E";
        drawText(text.data(),text.size(),x_pos_txt[1],1.25,-7.5);
        text="L";
        drawText(text.data(),text.size(),x_pos_txt[2],1.25,-7.5);
        text="C";//Audience
        drawText(text.data(),text.size(),x_pos_txt[3],1.25,-7.5);
        text="O";
